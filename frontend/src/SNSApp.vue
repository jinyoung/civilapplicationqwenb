            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    <v-list-item
                        ...
                        to="/citizenServiceApplications/serviceApplications"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="qualificationChecks"
                        to="/qualificationVerifications/qualificationChecks"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="documentManagements"
                        to="/documentManagements/documentManagements"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: '민원 서비스 신청', 
                description: 'ServiceApplication을 관리하는 화면입니다.', 
                key: 'serviceApplications', 
                route: '/citizenServiceApplications/serviceApplications',
                ImageUrl: '',
            },
            { 
                title: '자격 검증', 
                description: 'QualificationCheck을 관리하는 화면입니다.', 
                key: 'qualificationChecks', 
                route: '/qualificationVerifications/qualificationChecks',
                ImageUrl: '',
            },
            { 
                title: '문서 관리', 
                description: 'DocumentManagement을 관리하는 화면입니다.', 
                key: 'documentManagements', 
                route: '/documentManagements/documentManagements',
                ImageUrl: '',
            },
